...
%
%   solve_motion(U0, resume, N, tolP, wd, debug_flag)
%
...
function solve_motion_2(U0, resume, N, tolP, wd, debug_flag)
...
try
    ...
    if resume == true
        ...
        load oscillation_amplitudes.mat	oscillation_amplitudes
        load Rv.mat Rv
        load vz.mat vz
        load etas.mat etas			
        load pressure_amplitudes.mat pressure_amplitudes
        load nlmax.mat nlmax
        load ProblemConditions.mat ProblemConditions
        load z.mat z
        load numl.mat numl	
        load psMatPer.mat psMatPer			
        load tvec.mat tvec
        ...
        nsteps = ceil(5/(2*pi) * N^(3/2)); %minimum number of timesteps in one unit of time
