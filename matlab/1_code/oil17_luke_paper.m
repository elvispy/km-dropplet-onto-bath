...
muair = 0;
RhoS = 0.96; % must multiply by x1000
SigmaS = 20.50; % must multiply by x100
R = 0.075; % must multiply by x10
Ang = 180;
U = 17; % Has to be column vector
modes = 25;
...
function final_folder = create_folder_stucture(entry)
    ...
    fluid_parameters = sprintf("rho%gsigma%gnu%2.fmuair%g", entry.rho*1000, entry.sigma*100, entry.nu*10000, entry.muair);
