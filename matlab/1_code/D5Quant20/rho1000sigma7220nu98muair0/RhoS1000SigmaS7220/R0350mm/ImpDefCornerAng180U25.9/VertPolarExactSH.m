...
if runNumber == 0
    U0 = 25.9; save('U0.mat','U0')%impact velocity in cm/s (unit of velocity for the problem)
    ...
    % #--- 
    N = 25.95; % Number of harmonics contributing to the oscillation
    % #---0
