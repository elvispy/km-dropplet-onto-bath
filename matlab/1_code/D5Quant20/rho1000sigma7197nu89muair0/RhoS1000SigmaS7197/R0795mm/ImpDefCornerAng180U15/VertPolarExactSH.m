...
if runNumber == 0
    ...
    nsteps = 120; save('nsteps.mat','nsteps')%minimum number of timesteps in one unit of time
    ...
    % # ---
    z(1) = 1-1* zs_from_spherical(pi, oscillation_handle(oscillation_amplitudes(:, 1)));% -1*zsoftheta(pi,A2(1),A3(1)); %height of the centre of mass (CoM) in dimensionless units,
